...
<?php if(of_get_option('journal_displayslider')==1){
	...
	<div class="mission"><?php echo"<h1>Our mission is to work toward equality of educational opportunities and educational standards among all youth growing up in the Negev region.</h1>"; ?></div>
	<?php }else{?>
<!-- Begin #featuredPosts -->
	<?php
